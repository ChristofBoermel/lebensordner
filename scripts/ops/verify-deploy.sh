...
async function main() {
  ...
  await probe(`${baseUrl}/rest/v1/trusted_access_invitations?select=id,trusted_persons:trusted_person_id(user_id)&limit=1`, 'trusted_access invitation relation probe')
