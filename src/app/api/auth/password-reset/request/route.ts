...
import { checkRateLimit, incrementRateLimit, RATE_LIMIT_PASSWORD_RESET } from '@/lib/security/rate-limit'
import { logSecurityEvent, EVENT_PASSWORD_RESET_REQUESTED } from '@/lib/security/audit-log'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const attemptCount = RATE_LIMIT_PASSWORD_RESET.maxRequests - emailRateLimit.remaining - 1
