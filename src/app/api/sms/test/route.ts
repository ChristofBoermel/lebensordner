  ...
  try {
    ...
    try {
      ...
      if (twilioError.code === 21608) {
        errorMessage = 'Die Telefonnummer ist nicht verifiziert. Bitte verifizieren Sie Ihre Nummer in der Twilio Console unter "Verified Caller IDs".'
      } else if (twilioError.code === 21211) {
        errorMessage = 'Ungültiges Telefonnummernformat. Bitte verwenden Sie das internationale Format (z.B. +49170...).'
