...
export function Skeleton({ className }: SkeletonProps) {
  return (
    <div
      className={cn(
        'animate-pulse rounded-md bg-warmgray-200',
        className
      )}
    />
  )
...
export function SkeletonTable({ rows = 5 }: { rows?: number }) {
  return (
    <div className="space-y-3">
      <div className="flex gap-4 p-4 border-b border-warmgray-200">
...
export function SkeletonDocument() {
  return (
    <div className="flex items-center gap-4 p-4 rounded-lg border border-warmgray-200 bg-white">
